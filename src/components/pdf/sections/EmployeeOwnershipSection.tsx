...
const EmployeeOwnershipSection = () => (
  <Page size="A4" style={tw("flex flex-col bg-background px-10 pt-10 pb-4")}>
    ...
    <Text style={tw("text-[13.5px] font-semibold text-foreground")}>
      The United States is confronting a{" "}
      <Text style={tw("font-bold")}>"silver tsunami"</Text> of retiring business
      owners that are likely to sell their businesses over the next decade.
      <Text style={tw("font-medium")}>
        {" "}
        Meanwhile, too many American workers and families are financially
      ...
      <View style={tw("flex-1")}>
        <Text style={tw("text-[11px] text-foreground")}>
          <Text style={tw("font-bold")}>
            Without a policy strategy to address business succession, we risk
            the loss of American businesses and their local jobs.
          </Text>{" "}
          Too often, the sale of a business to an out-of-state or foreign buyer
          results in the loss of local jobs and investment. With many businesses
          in critical industries—e.g., those with implications for national and
          economic security—facing the challenges of business succession,
          promoting employee ownership can be part of a broader competition
          framework to maintain our leadership in strategic sectors while
        ...
        <Text style={tw("text-[11px] text-foreground mt-4")}>
          ...
          The{" "}
          <Text style={[tw("italic underline")]}>
            Employee Stock Ownership Plan
          </Text>{" "}
          (ESOP) is both a retirement plan and corporate finance vehicle that
          allows retiring business owners to sell their business to employees.
          Employees do not pay for their shares—employee ownership is instead an
          incremental benefit on top of wages and benefits. ESOPs have been
          demonstrated to create over 2.5 times more retirement wealth for
          workers—in addition to superior pay and benefits—compared to
          traditional companies.<SuperScript>23</SuperScript> Employee-owned
          businesses have also been shown to innovate more frequently and
          exhibit greater resilience during an economic downturn.
